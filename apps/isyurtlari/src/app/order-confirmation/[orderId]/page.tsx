        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {order.bankDetails?.eksik ? (
                  <div className="bg-white rounded-xl p-6 border border-amber-300">
                    ...
                    <p className="text-sm text-gray-700">
                      ...
                      <a href="mailto:info@isyurtlari.com.tr" className="text-[#BA4700] font-semibold underline">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-3">
              ...
              >
                <div className="flex items-center gap-2">
                  <LuHouse size={18} className="text-gray-600 group-hover:text-[#BA4700]" />
                  <span className="font-medium text-gray-900 group-hover:text-[#BA4700]">Ana Sayfa</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-[#BA4700]">Alışverişe Devam Et</span>
                </div>
                <LuArrowRight size={16} className="text-gray-400" />
              </Link>
            </div>
