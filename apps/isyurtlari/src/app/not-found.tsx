  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 flex items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        {/* 404 Number */}
        <div className="mb-8">
          <h1 className="text-9xl font-bold text-[#BA4700] opacity-10 mb-4">404</h1>
        ...
        <div className="mb-8">
          <div className="inline-block bg-white rounded-full p-6 shadow-lg">
            <IconCart className="w-12 h-12 text-[#BA4700]" />
          </div>
        </div>
        ...
        <button
          ...
          className="mt-6 inline-flex items-center gap-2 text-[#BA4700] hover:text-[#BA4700] font-medium transition-colors"
        >
